...
function Profile() {
  ...
  const renderProfileContent = () => {
    switch (activeProfileSection) {
      case "personal-info":
        return (
          <ProfileInfo profileData={profileData} onUpdate={fetchProfileData} />
        );
      case "technical-skills":
        return (
          <SkillsTable profileData={profileData} onUpdate={fetchProfileData} />
        );
        ...
        <section className="flex flex-row w-full flex-grow">
          {activeTab === "profile" && profileData && (
            <section className="left-sec w-1/5 p-6">
              ...
              <ProgressBar
                progress={profileData.profile_completion_percentage || 0}
              />
              ...
              <div className="mt-10 flex flex-col w-full gap-3">
                {[
                  ...
                  <button
                    key={section}
                    className={`profile-btn text-left pl-5 w-full py-2 rounded ${
          ...
          <section
            className={`right-sec ${
              activeTab === "profile" ? "w-4/5" : "w-full"
            } p-10`}
          >
