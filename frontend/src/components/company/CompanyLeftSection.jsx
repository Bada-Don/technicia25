...
const CompanyLeftSection = () => {
  return (
    <div className="flex-1 py-5 flex flex-col  bg-transparent space-y-0 md:space-y-2">
      {/* Adjust the heading size based on screen size */}
      <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-6xl font-bold leading-snug md:leading-relaxed text-center md:text-left">
